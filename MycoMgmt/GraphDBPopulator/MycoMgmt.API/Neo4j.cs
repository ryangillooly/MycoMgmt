      ...
      public class Neo4j
      {
          ...
          public static async Task Main()
          {
             ...
             /* var location = new Location
              {
                  Name = "GrowTent",
                  Created = new Created { On = DateTime.Now, ByUserId = user }
              };
*/
      ...
      public static class Extensions
      {
          ...
          public static void CreateCulture(this IAsyncSession session, Culture culture)
          {
              ...
              session.WriteToDatabase(
                  $@"MERGE (:Culture{culture.IsSuccessful()}{":" + culture.Type}{culture.IsPurchase()} {{ Name: '{culture.Name}' }});");
              session.WriteToDatabase($@"
                MATCH 
          ...
          public static void CreateNodes(this IAsyncSession session)
          {
              ...
              session.WriteToDatabase(
                  $"MERGE (:Strain {{ Name: 'Golden Teacher', Effects: ['Visuals','Calming','Oneness']}})");
